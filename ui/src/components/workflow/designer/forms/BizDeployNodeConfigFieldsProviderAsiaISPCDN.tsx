...
const BizDeployNodeConfigFieldsProviderAsiaISPCDN = () => {
    ...
    <>
      ...
      <Show when={fieldDomainMatchPattern !== DOMAIN_MATCH_PATTERN_CERTSAN}>
        <Form.Item
          ...
          label={t("workflow_node.deploy.form.asiaispcdn_domain.label")}
          rules={[formRule]}
        >
          <Input placeholder={t("workflow_node.deploy.form.asiaispcdn_domain.placeholder")} />
        </Form.Item>
      </Show>
    </>
  );
...
const _default = Object.assign(BizDeployNodeConfigFieldsProviderAsiaISPCDN, {
  getInitialValues,
  getSchema,
});
